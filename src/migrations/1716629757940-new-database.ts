...
export class NewDatabase1716629757940 implements MigrationInterface {
   ...
   public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "product" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "enabled" boolean NOT NULL DEFAULT true, "id" SERIAL NOT NULL, "featuredAssetId" integer, "customFieldsFeaturedreviewid" integer, "customFieldsMake" character varying(255), "customFieldsDescription" character varying(255), "customFieldsModel" character varying(255), "customFieldsYear" integer, "customFieldsCountryoforigin" character varying(255), "customFieldsCondition" character varying(255), "customFieldsCategory" character varying(255), "customFieldsSubcategory" character varying(255), "customFieldsReviewrating" double precision, "customFieldsReviewcount" double precision DEFAULT '0', CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "custom_user" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "email" character varying, "phone" character varying, "password" character varying, "avatarId" integer, "fullName" character varying, "roles" text, "emailVerified" boolean NOT NULL DEFAULT false, "type" character varying NOT NULL, CONSTRAINT "UQ_c4d9dfdcd0a22c265eddd2c42cd" UNIQUE ("email"), CONSTRAINT "UQ_51ac14660024fa4e26da4345e4c" UNIQUE ("phone"), CONSTRAINT "PK_b266e6248cae3b914b4c9b6f69b" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE INDEX "IDX_a05cc65ec2c8caa7b0b3dab891" ON "custom_user" ("type") `, undefined);
        await queryRunner.query(`CREATE TABLE "rider_request" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "orderId" character varying NOT NULL, "pickUpAddress" character varying NOT NULL, "pickUpDistance" double precision NOT NULL, "dropOffAddress" character varying NOT NULL, "dropOffDistance" double precision NOT NULL, "totalDistance" double precision NOT NULL, "payment" double precision NOT NULL, "deliveryProofId" integer NOT NULL, "estimatedTime" character varying NOT NULL, "status" character varying NOT NULL DEFAULT 'pending', "riderId" integer, "sellerId" integer, CONSTRAINT "PK_2bc448eb8f1a406936c92c62aa7" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "transaction" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "initiator_id" integer NOT NULL, "type" character varying NOT NULL, "amount" numeric(10,2) NOT NULL, "status" character varying NOT NULL, "seller_id" integer, "rider_id" integer, CONSTRAINT "PK_89eadb93a89810556e1cbcd6ab9" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "rider" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "email" character varying, "phone" character varying, "password" character varying, "avatarId" integer, "fullName" character varying, "roles" text, "emailVerified" boolean NOT NULL DEFAULT false, "userId" character varying, "vehicleRegistrationFileId" integer NOT NULL, "nationalIdCardId" integer NOT NULL, "online" boolean NOT NULL DEFAULT false, "vehicleType" character varying NOT NULL, "status" character varying NOT NULL DEFAULT 'pending', "walletId" integer, CONSTRAINT "UQ_bcd77a964c7fce52c5910bf2621" UNIQUE ("email"), CONSTRAINT "UQ_61ee0538157cd1416fe1bc80dda" UNIQUE ("phone"), CONSTRAINT "PK_1ed6540e613592e2a470a162ef1" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "wallet" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "fullName" character varying(255) NOT NULL, "recipients" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "balance" numeric(10,2) NOT NULL, "paymentMethod" character varying(100) NOT NULL, "accountNumber" integer NOT NULL, "riderId" integer, "sellerId" integer, CONSTRAINT "PK_bec464dd8d54c39c54fd32e2334" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "custom_seller" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "email" character varying, "phone" character varying, "password" character varying, "avatarId" integer, "fullName" character varying, "roles" text, "emailVerified" boolean NOT NULL DEFAULT false, "userId" character varying, "shopName" character varying(100) NOT NULL, "TIN" character varying(20) NOT NULL, "businessRegistrationFileId" integer NOT NULL, "shopAddress" character varying(255) NOT NULL, "aboutShop" text NOT NULL, "status" character varying NOT NULL DEFAULT 'pending', "walletId" integer, CONSTRAINT "UQ_b93d38097d195ffae4110bc9099" UNIQUE ("email"), CONSTRAINT "UQ_d68edd75f23640a4f39a962b093" UNIQUE ("phone"), CONSTRAINT "PK_890d4bd6ebd6fbfabdd81faee3a" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "customer_product_request" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "productName" character varying NOT NULL, "quantity" integer NOT NULL, "make" character varying NOT NULL, "model" character varying NOT NULL, "description" character varying, "year" character varying NOT NULL, "countryOfOrigin" character varying, "condition" character varying NOT NULL, "productRequestImageId" integer, "bestBidAmount" integer, "bestBidSellerId" integer, "customerId" integer, CONSTRAINT "PK_949e71fe9e2657aa5ac5fbdd3f9" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "user_address" ("id" SERIAL NOT NULL, "title" character varying, "city" character varying, "street" character varying, "GPS" character varying, "customerId" integer, CONSTRAINT "PK_302d96673413455481d5ff4022a" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "wishlist_item" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "productVariantId" integer NOT NULL, "customerId" integer, CONSTRAINT "PK_dc473007d691690801365193b72" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "report" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "orderNumber" character varying NOT NULL, "issueType" character varying NOT NULL, "description" character varying NOT NULL, "itemImageId" integer, "customerId" integer, CONSTRAINT "PK_99e4d0bea58cba73c57f935a546" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "custom_customer" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "email" character varying, "phone" character varying, "password" character varying, "avatarId" integer, "fullName" character varying, "roles" text, "emailVerified" boolean NOT NULL DEFAULT false, "userId" character varying, CONSTRAINT "UQ_995a220ab7f2518b46154eb4b09" UNIQUE ("email"), CONSTRAINT "UQ_b50f885294b9e02e997eddccc91" UNIQUE ("phone"), CONSTRAINT "PK_e71cad6b96e2c6a326b53f77503" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "custom_user" ADD CONSTRAINT "FK_c7eb11e748c02037124ab93738d" FOREIGN KEY ("avatarId") REFERENCES "asset"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "rider_request" ADD CONSTRAINT "FK_ae1a79285b6ed39407972d00a86" FOREIGN KEY ("riderId") REFERENCES "rider"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "rider_request" ADD CONSTRAINT "FK_e3decda1d7ab678f472faefa4c6" FOREIGN KEY ("sellerId") REFERENCES "custom_seller"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "rider_request" ADD CONSTRAINT "FK_517c8617ca72c22da12f83039f6" FOREIGN KEY ("deliveryProofId") REFERENCES "asset"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "transaction" ADD CONSTRAINT "FK_d039bb371ba27911447b75f07d8" FOREIGN KEY ("seller_id") REFERENCES "custom_seller"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "transaction" ADD CONSTRAINT "FK_08e5f00beefa8a79273083ad39a" FOREIGN KEY ("rider_id") REFERENCES "rider"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "rider" ADD CONSTRAINT "FK_2397cfb7a97bcb5e8ff77bae252" FOREIGN KEY ("avatarId") REFERENCES "asset"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "rider" ADD CONSTRAINT "FK_521090e640e11ac9aedd1806847" FOREIGN KEY ("vehicleRegistrationFileId") REFERENCES "asset"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "rider" ADD CONSTRAINT "FK_11b8117d524b9d8a032dbfb47ea" FOREIGN KEY ("nationalIdCardId") REFERENCES "asset"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "rider" ADD CONSTRAINT "FK_4ef1ae8582a9efbff84a7f1bc44" FOREIGN KEY ("walletId") REFERENCES "wallet"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "wallet" ADD CONSTRAINT "FK_32717ea01e938042c040bbf5af2" FOREIGN KEY ("riderId") REFERENCES "rider"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "wallet" ADD CONSTRAINT "FK_93e7b0799528c71fb708f60af31" FOREIGN KEY ("sellerId") REFERENCES "custom_seller"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "custom_seller" ADD CONSTRAINT "FK_e2bdc245da4a726671d7ba36125" FOREIGN KEY ("avatarId") REFERENCES "asset"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "custom_seller" ADD CONSTRAINT "FK_238c1cafdf567b89908307838e1" FOREIGN KEY ("businessRegistrationFileId") REFERENCES "asset"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "custom_seller" ADD CONSTRAINT "FK_469fc3051f265ae6642815f4650" FOREIGN KEY ("walletId") REFERENCES "wallet"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "customer_product_request" ADD CONSTRAINT "FK_78450037f9c7014d06b453dac32" FOREIGN KEY ("productRequestImageId") REFERENCES "asset"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "customer_product_request" ADD CONSTRAINT "FK_3707d34b907fc659b66c1233d35" FOREIGN KEY ("customerId") REFERENCES "custom_customer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "user_address" ADD CONSTRAINT "FK_413ea52236371cf5841a689358a" FOREIGN KEY ("customerId") REFERENCES "custom_customer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "wishlist_item" ADD CONSTRAINT "FK_23cb8f58212ad0af752dd3e67e7" FOREIGN KEY ("customerId") REFERENCES "custom_customer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "report" ADD CONSTRAINT "FK_31b1257ec0c387442aeb513a88e" FOREIGN KEY ("itemImageId") REFERENCES "asset"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "report" ADD CONSTRAINT "FK_af0ab438a1e8dc4878cdc44948e" FOREIGN KEY ("customerId") REFERENCES "custom_customer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "custom_customer" ADD CONSTRAINT "FK_6fcc6a954bd85efcce1831bbb6d" FOREIGN KEY ("avatarId") REFERENCES "asset"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
   ...
   public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "custom_customer" DROP CONSTRAINT "FK_6fcc6a954bd85efcce1831bbb6d"`, undefined);
        await queryRunner.query(`ALTER TABLE "report" DROP CONSTRAINT "FK_af0ab438a1e8dc4878cdc44948e"`, undefined);
        await queryRunner.query(`ALTER TABLE "report" DROP CONSTRAINT "FK_31b1257ec0c387442aeb513a88e"`, undefined);
        await queryRunner.query(`ALTER TABLE "wishlist_item" DROP CONSTRAINT "FK_23cb8f58212ad0af752dd3e67e7"`, undefined);
        await queryRunner.query(`ALTER TABLE "wishlist_item" DROP CONSTRAINT "FK_acb085dfe252134ae370f57fd4d"`, undefined);
        await queryRunner.query(`ALTER TABLE "user_address" DROP CONSTRAINT "FK_413ea52236371cf5841a689358a"`, undefined);
        await queryRunner.query(`ALTER TABLE "customer_product_request" DROP CONSTRAINT "FK_3707d34b907fc659b66c1233d35"`, undefined);
        await queryRunner.query(`ALTER TABLE "customer_product_request" DROP CONSTRAINT "FK_9e591069bbd36d35e185fb21bfb"`, undefined);
        await queryRunner.query(`ALTER TABLE "customer_product_request" DROP CONSTRAINT "FK_78450037f9c7014d06b453dac32"`, undefined);
        await queryRunner.query(`ALTER TABLE "custom_seller" DROP CONSTRAINT "FK_469fc3051f265ae6642815f4650"`, undefined);
        await queryRunner.query(`ALTER TABLE "custom_seller" DROP CONSTRAINT "FK_238c1cafdf567b89908307838e1"`, undefined);
        await queryRunner.query(`ALTER TABLE "custom_seller" DROP CONSTRAINT "FK_e2bdc245da4a726671d7ba36125"`, undefined);
        await queryRunner.query(`ALTER TABLE "wallet" DROP CONSTRAINT "FK_93e7b0799528c71fb708f60af31"`, undefined);
        await queryRunner.query(`ALTER TABLE "wallet" DROP CONSTRAINT "FK_32717ea01e938042c040bbf5af2"`, undefined);
        await queryRunner.query(`ALTER TABLE "rider" DROP CONSTRAINT "FK_4ef1ae8582a9efbff84a7f1bc44"`, undefined);
        await queryRunner.query(`ALTER TABLE "rider" DROP CONSTRAINT "FK_11b8117d524b9d8a032dbfb47ea"`, undefined);
        await queryRunner.query(`ALTER TABLE "rider" DROP CONSTRAINT "FK_521090e640e11ac9aedd1806847"`, undefined);
        await queryRunner.query(`ALTER TABLE "rider" DROP CONSTRAINT "FK_2397cfb7a97bcb5e8ff77bae252"`, undefined);
        await queryRunner.query(`ALTER TABLE "transaction" DROP CONSTRAINT "FK_08e5f00beefa8a79273083ad39a"`, undefined);
        await queryRunner.query(`ALTER TABLE "transaction" DROP CONSTRAINT "FK_d039bb371ba27911447b75f07d8"`, undefined);
        await queryRunner.query(`ALTER TABLE "rider_request" DROP CONSTRAINT "FK_517c8617ca72c22da12f83039f6"`, undefined);
        await queryRunner.query(`ALTER TABLE "rider_request" DROP CONSTRAINT "FK_e3decda1d7ab678f472faefa4c6"`, undefined);
        await queryRunner.query(`ALTER TABLE "rider_request" DROP CONSTRAINT "FK_ae1a79285b6ed39407972d00a86"`, undefined);
        await queryRunner.query(`ALTER TABLE "custom_user" DROP CONSTRAINT "FK_c7eb11e748c02037124ab93738d"`, undefined);
        ...
        await queryRunner.query(`DROP TABLE "custom_customer"`, undefined);
        await queryRunner.query(`DROP TABLE "report"`, undefined);
        await queryRunner.query(`DROP TABLE "wishlist_item"`, undefined);
        await queryRunner.query(`DROP TABLE "user_address"`, undefined);
        await queryRunner.query(`DROP TABLE "customer_product_request"`, undefined);
        await queryRunner.query(`DROP TABLE "custom_seller"`, undefined);
        await queryRunner.query(`DROP TABLE "wallet"`, undefined);
        await queryRunner.query(`DROP TABLE "rider"`, undefined);
        await queryRunner.query(`DROP TABLE "transaction"`, undefined);
        await queryRunner.query(`DROP TABLE "rider_request"`, undefined);
        await queryRunner.query(`DROP INDEX "public"."IDX_a05cc65ec2c8caa7b0b3dab891"`, undefined);
        await queryRunner.query(`DROP TABLE "custom_user"`, undefined);
